...
class CurrencyChange
{
    ...
    {
        return $this->defaultCurrency ? $this->defaultCurrency->currency_symbol : '';
    }

    public function format($amount)
    {
        // Check if $this->defaultCurrency is set before using its properties
        if ($this->defaultCurrency) {
            ...
            // Handle the case where $this->defaultCurrency is not set
